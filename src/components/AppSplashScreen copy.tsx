...
export const AppSplashScreen: React.FC<AppSplashScreenProps> = ({
  ...
  useEffect(() => {
    // 🟢 1. Fade-in elegante da tela e entrada do card
    Animated.parallel([
    ...
    // 🟢 2. Efeito "Heartbeat" sutil e constante
    ...
    // 🟢 3. Animação fluida da Barra de Progresso
  ...
  return (
    <Animated.View style={[styles.container, { opacity: opacityAnim }]}>
      ...
      >
        {/* Container Limpo da Logo (Sem Borda Branca/Anel) */}
        ...
        {/* Nome do Produto */}
        <Text style={styles.brandTitle}>DuoElo</Text>
      ...
      {/* Footer de Carregamento Elegante */}
      <View style={styles.loaderFooter}>
        <Text style={styles.loadingMessage}>{displayMessage}</Text>
        
        {/* Barra de Progresso Premium (#EAB64A -> #67D4A8) */}
...
const styles = StyleSheet.create({
  container: {
    ...
    backgroundColor: "#F0F4F8", // Fundo idêntico à tela de login
  ...
  logoFrame: {
    ...
    overflow: "hidden", // 🟢 Corta qualquer borda indesejada
    shadowColor: "#000",
